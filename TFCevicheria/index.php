...
<head>
    ...
    <link rel="contenedor" href="css/carga.css">
    <title>Login Cevicheria</title>
</head>

<body background="imagen/fondocev.jpg">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                <img src="imagen/can.png" height="300px" width="100%" alt="">
            </div>
        </div>
        <div class="row">
